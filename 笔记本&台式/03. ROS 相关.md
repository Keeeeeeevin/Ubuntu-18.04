...
https://github.com/ros/geometry.git -b melodic-devel（或直接下载，目录~/Software/catkins/catkin_tf/src/geometry，melodic-devel分支）
...
```html
# source
source ~/Software/catkins/catkin_tf/setup.bash
python3
import tf2
```
