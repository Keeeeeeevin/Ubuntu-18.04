...
* 安装目录
```html
mkdir -p ~/Software/catkins/catkin_cv_bridge/src
cd ~/Software/catkins/catkin_cv_bridge
catkin_make
cd ~/Software/catkins/catkin_cv_bridge/src
git clone https://github.com/ros-perception/vision_opencv.git（关闭科学上网）
```
