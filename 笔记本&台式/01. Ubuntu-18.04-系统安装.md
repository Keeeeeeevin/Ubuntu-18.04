...
4. 若在安装界面卡死、黑屏情况，在选择光标界面指向“Install Ubuntu”，按e键（或Shift、ESC键），找到“quiet splash - - -”改成为“quiet splash acpi=off”，然后继续安装（即关闭：Advanced Configuration and Power Interface）。
